...
class DataController(BaseController): 
   ...
   def vaildate_uploading_file(self , file:UploadFile):   

       # we need check if type of file is vaild 
      ...
      if file.size > (self.app_settings.FILE_MAX_SIZE * self.size_scale) : 
         """
            file.size:Attribute return size in Byte But we set vaildation in MGByte
   ...
   def generate_unique_filename(self , ori_file_name: str ,file_id:str ) : 
